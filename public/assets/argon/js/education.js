...
$(document).ready(function () {
    ...
    var column_list = [
        ...
        },
        {
            ...
            render: function (data, type, row) {
                var date_finish = (row.date_finish == null) ? 'Present' : tgl_id_short(row.date_finish);
                var btn = tgl_id_short(data) + ' - ' + date_finish;
                return btn;
            },
        ...
        },
        {
            ...
            render: function (data, type, row) {
                var btn = '<div class="btn-group" role="group" aria-label="Basic example">' +
                    ...
                    ' data-post-id="' + data + '"' +
                    ' data-action-url="education/formEdit"' +
    ...
    tableGeneral = $('.tableGeneral').DataTable({
        ...
        "sAjaxSource": base_url('education/jsonDataTable'),
        buttons: {
            dom: {
                button: {
                    tag: 'button',
