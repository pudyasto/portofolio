...
<div class="row">
    <div class="col-lg-12">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="company" id="company" placeholder="Company" value="<?= (isset($row['company'])) ? $row['company'] : ''; ?>" required>
        </div>
    </div>
    <div class="col-lg-12">
        <div class="form-group">
            <label class="form-control-label" for="position">Position</label>
            <input type="text" class="form-control" name="position" id="position" placeholder="Position" value="<?= (isset($row['position'])) ? $row['position'] : ''; ?>" required>
        </div>
    </div>
    <div class="col-lg-12">
        <div class="form-group">
...
<?= form_close(); ?>
<script src="/assets/argon/js/work-form.js?v=1.0"></script>