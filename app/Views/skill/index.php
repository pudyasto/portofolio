        ...
        <div class="card">
            ...
            <div class="card-header border-0">
                <div class="mb-2">
                    ...
                    <button type="button" data-toggle="modal" data-title="Add Data" data-post-id="" data-action-url="skill/formAdd" data-target="#form-modal" class="btn btn-sm btn-primary">Add New</button>
                ...
                <table class="table align-items-center table-flush tableGeneral">
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th>Description</th>
                            <th style="width: 80px;">Skill Point</th>
...
<script src="/assets/argon/js/skill.js?v=1.0"></script>
<?= $this->endSection() ?>